...
%% Specify your last name and first name (as given in the .bib) to automatically bold your own name in the publications list. One caveat: You need to write \bibnamedelima where there's a space in your name for this to work properly for now...
 \myname{Evia}{Pablo\bibnamedelima Ernesto}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Pablo Ernesto Evia Salas, Ph.D.}

  \makefield{\faEnvelope[regular]}{\texttt{pablo.evia@daad-alumni.de}}
  \makefield{\faTwitter}{\texttt{@pabloevia}}

  \makefield{\faGlobe}{\url{https://bit.ly/2YEz4KC}}

  \makefield{\faLinkedin}
  {\url{https://www.linkedin.com/in/pablo-evia-29420411/}}
}
